...
<CardGroup cols={3}>
  <Card title="Client API" icon="user" href="/api-reference/client/overview">
    Submit client data
  </Card>
  <Card title="Employee API" icon="id-badge" href="/api-reference/employee/overview">
    Submit employee data
  </Card>
  <Card title="Visit API" icon="calendar-check" href="/api-reference/visit/overview">
    Submit visit data
  </Card>
</CardGroup>
